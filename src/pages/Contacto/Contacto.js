const Contacto = () => {
    return (
        ...
        <section className="py-5">
          ...
          ></iframe>
          <div className="text-start ms-5 px-5">
          ...
          <p className="text-secondary">
            Sábados de <span className="fw-bold">10 a 14hs.</span>
                    ...
                    <div className="col-12 col-lg-6">
                        ...
                        <p className="text-center mb-3 px-5">Ante cualquier duda o consulta sobre nuestros cursos, <br className="d-none d-md-block" /> dejanos tu mensaje y te responderemos a la brevedad.</p>
                        <form className="w-75 mx-auto">
                            ...
                            <div className="text-center">
                                <button type="submit" class="btn btn-primary border-0 text-uppercase">Enviar</button>
                            </div>
                        </form>
                    </div>
