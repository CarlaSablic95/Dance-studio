...
import Adolescentes from './img/adolescentes.webp';
import Jovenes from './img/jovenes.webp';
import 'animate.css'
                ...
                <div className="seccion-principal">
                    <div className='d-flex justify-content-evenly align-items-center'>
                        ...
                        <div className='position-relative contenedor-imagen d-none d-lg-block'>
                            <img src={Imagen1} alt="" className='bailarina animate__animated animate__flash' />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className='d-flex justify-content-center align-items-center position-relative'>
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md-6 p-3 my-md-5">
                            <h2 className='fw-bolder px-5 text-uppercase text-center text-md-start'>Nosotros</h2>
