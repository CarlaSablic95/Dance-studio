                ...
                <div className="row justify-content-evenly mb-5">
                    <div class="card col-10 col-md-4 mb-5 px-0 card-testimony mb-3">
                            <div class="card-body">
                                ...
                                <hr />
                                <blockquote class="blockquote mb-0 text-end"><cite title="Source Title" className="fs-6">Ana - estudiante</cite>
                                </blockquote>
                            </div>
                    ...
                    <div class="card col-10 col-md-4 mb-5 px-0 card-testimony mb-3">
                        ...
                        <hr />
                                <blockquote class="blockquote mb-0 text-end"><cite title="Source Title" className="fs-6">Lucas - estudiante</cite>
                                </blockquote>
                        </div>
                    </div>
                    ...
                    <div class="card col-10 col-md-4 mb-5 px-0 card-testimony mb-3">
                        <div class="card-body">
                            ...
                            <hr />
                                <blockquote class="blockquote mb-0 text-end"><cite title="Source Title" className="fs-6">Delfina - egresada</cite>
                                </blockquote>
                        </div>
                    </div>
                </div>
